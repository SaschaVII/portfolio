    ...
    return (
        <div className={styles}>
            <a href={projectUrl || ""} target="_blank">
                <img className="object-cover w-[375px] h-[375px] saturate-0 brightness-150 group-hover:saturate-100 group-hover:brightness-100 transition ease-in-out duration-500" src={thumbnailSrc} alt={title + ' thumbnail'} />
            </a>
