            ...
            <div className="container mt-5 sm:mt-20">
                <section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <ProjectCard title="This Portfolio" projectUrl="/about" thumbnailSrc="/portfolio_proj_thumbnail.png" animation={true}>
                            <p>
                        ...
                        <ProjectCard title="Sticky Notes" projectUrl="https://saschavii.github.io/StickyNotesApp/" thumbnailSrc="/stickyNotes_proj_thumbnail.png" animation={true}>
                            <p>
